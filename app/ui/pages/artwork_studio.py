...
class ArtworkStudioPage(QWidget):
    ...
    def _build_left_panel(self) -> QWidget:
        panel = QGroupBox("IMAGE / VECTOR TOOLS")
        panel.setObjectName("studioPanel")
        panel.setMinimumWidth(245)
        layout = QVBoxLayout(panel)

        size_box = QGroupBox("Selected object / group size")
        ...
        size_form.addRow(self.lock_proportions)
        size_form.addRow(self.apply_size_button)
    ...
    def resize_selected(self) -> None:
        ...
        if self.lock_proportions.isChecked() and self.details is not None:
    ...
    def _render(self) -> None:
        ...
        metres = (self.details.length_mm / Decimal("1000")).quantize(Decimal("0.001"))
        self.usage.setText(f"DTF metres: {metres} m")
